...
class ExceptionHandler implements HandlerInterface
{
    ...
    public function render($request, Throwable $e)
    {
        ...
        $result = json_decode($this->toIlluminateResponse($response, $transformed)->original)->errors[0];
        return $this->generalResponse(false,$result->status,$result->title,$result->detail,'errorId:'.$result->id);
