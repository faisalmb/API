...
return [
    ...
    */
    ...
    'transformers' => [
        ...
        GrahamCampbell\Exceptions\Transformer\ValidationTransformer::class,
        GrahamCampbell\Exceptions\Transformer\ModelTransformer::class,
        GrahamCampbell\Exceptions\Transformer\TransformerInterface::class,
    ],
    ...
    */
    ...
    'default' => GrahamCampbell\Exceptions\Displayer\JsonDisplayer::class,
